...
public class CustomerSettingsActivity extends AppCompatActivity {
    ...
    private EditText mNameField, mPhoneField,mTourPeriod;

    private TextView mPackageChosen, mTourPlan , mTourPrice;
    ...
    private String data; //need to be fix if its wrong
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPackageChosen = (TextView)findViewById(R.id.packageChosen);
        mTourPlan = (TextView)findViewById(R.id.tourPlaned);
